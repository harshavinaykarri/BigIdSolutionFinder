...
def load_solutions():
    try:
        with open("/Users/hkarri/python_local/BigID_Solution_Finder/output.txt", "r") as file:
            ...
            print(f"Solutions loaded successfully: {solutions}")  # Debugging
            return solutions
...
def switch_to_feedback():
    ...
    print(f"Switching to feedback with solutions: {solutions}")  # Debugging
    return gr.update(value="Feedback"), gr.update(choices=solutions)
...
with gr.Blocks() as interface:
    ...
    with chatbot_container:
        ...
        # Initialize the Dropdown without hardcoding choices
        solution_input = gr.Dropdown(choices=None, label="solution", value="", allow_custom_value=True)

        feedback_button.click(switch_to_feedback, inputs=[], outputs=[choice, solution_input])
